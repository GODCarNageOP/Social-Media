...
const Footer = () => {
    return (
     <div className="footer w-[30%] border-x flex flex-col h-full">
        <div className="search h-[3%] w-84 rounded-full bg-gray-100 flex mt-3 items-center justify-start p-3 gap-2 mx-10">
            <SearchIcon className='text-gray-500'/>
            <input type="text" placeholder="Search Twitter" className="bg-transparent border-none outline-none"/>
        </div>
        <div className="updates mx-10 bg-gray-100 rounded-lg h-[50%] mt-3 flex flex-col cursor-pointer">
            <h1 className='p-3 text-xl font-semibold ml-2'>What's happening</h1>
            <div className='flex p-3 justify-between hover:bg-gray-200'>
                <div className="message flex flex-col items-start text-gray-500 gap-1 ml-2">
                    <span className='text-xs'>NBA This morning</span>
                    <h1 className='font-semibold text-black text-sm'>Lakers at Nuggets</h1>
            ...
            <div className='flex p-3 justify-between hover:bg-gray-200'>
                <div className="message flex flex-col items-start text-gray-500 gap-1 ml-2">
                    <span className='text-xs'>Sports Trending</span>
                    <h1 className='font-semibold text-black text-sm'>#ParimatchJeetKaTyohaar</h1>
                    <p className='text-xs'>2,107 Tweets</p>
                </div>
                <MoreHorizOutlinedIcon className=' mr-2 text-gray-600'/>
            </div>
            <div className='flex p-3 justify-between hover:bg-gray-200'>
                <div className="message flex flex-col items-start text-gray-500 gap-1 ml-2">
            ...
            <span className='p-3 text-blue-400 ml-2'>Show More</span>
        </div>
        <div className="follow mt-3 mx-10 bg-gray-100 rounded-lg h-[30%] flex flex-col">
            ...
            <div className="profile flex justify-between items-center p-3 h-16  hover:bg-gray-200">
                ...
                <button className='bg-black text-white rounded-full w-20 h-8 font-semibold mr-2'>Follow</button>
            </div>
            <div className="profile flex justify-between items-center p-3 h-16 hover:bg-gray-200">
                <div className='flex gap-2 ml-2'>
                <img src={yash} alt="" className='h-12 w-12 rounded-full' />
            ...
            <div className="profile flex justify-between items-center p-3 h-16 hover:bg-gray-200 mt-2">
                <div className='flex gap-2 ml-2'>
                <img src={yash} alt="" className='h-12 w-12 rounded-full' />
                <div className="name flex flex-col">
                    <h1 className='text-base font-semibold'>Yash Harale</h1>
